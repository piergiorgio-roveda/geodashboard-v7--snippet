...
function page__variables__get($_page__slug){
  ...
  // --- Ready for Loop!
    ...
    // --- Ready for Columns Loop!
      ...
      $_p['page_lang'] = 'en-US';
      $_p['g_template'] = 'base';
      $_p['title_seo'] = 'List Of Snippets';
      $_p['g_description_short'] = 'Complete list of [GEO]DASHBOARD Snippets.';
      $_p['g_description'] = 'Complete list of [GEO]DASHBOARD Snippets.';
      $_p['created_at'] = '2024-06-19T10:00:00+00:00';
      $_p['update_at'] = '2024-06-19T10:00:00+00:00';
    // --- Columns Loop --END
